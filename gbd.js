...
casper.start(url, function() {
    var loading_div = "div[style*='position: absolute; left: 0px; color: rgb(128, 128, 128); font-size: 13px; background-color: white; bottom: 0px; -webkit-user-select: none;']";
    ...
    casper.then(function(){
        ...
        this.waitFor(
                function() {
                    ...
                    var elem = this.evaluate(function(){
                        var viewport_div = "div[id='viewport'] > div > div > div";
                        var elem = document.querySelector(viewport_div).offsetParent;
                        return elem;
                    });
                    var current_position = elem.scrollHeight - elem.scrollTop - elem.offsetHeight;
